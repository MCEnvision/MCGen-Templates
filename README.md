...
The current Phase 3 evidence set contains fifteen immutable source snapshots, including the retained historical Forge capture, and a content-addressed catalog with 1,473 shards. Every accepted source entry is represented in a catalog shard; rejected upstream values remain explicit in their source snapshot. No catalog component is a verified generated-project tuple.
