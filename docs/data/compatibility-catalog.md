...
An unexplained gap is a validation failure. Rejected source values remain in their source snapshot with their parser reason and do not become invisible catalog entries.
