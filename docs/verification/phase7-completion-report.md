...
The rejected values are not silent omissions. They are catalog coverage blockers and remain visible in the current coverage document. The catalog is therefore complete as a source representation, but it is not evidence that every discovered component can generate or compile a project.
...
|   4 | Every discovered version and exact artifact appears in the catalog or has an explicit blocker                                         | Passed                  | Current coverage represents 27,706 accepted entries and records all 20 rejected records with exact blockers.                                                                                                                                                                      |
...
|  12 | Accurate status and blocker for every nonverified discovered tuple                                                                    | Passed                  | Catalog rejections, blocked profiles, blocked descriptors, and Phase 5 audit reasons are explicit and content addressed.                                                                                                                                                          |
