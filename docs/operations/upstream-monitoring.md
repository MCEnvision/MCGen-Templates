...
Scheduled maintenance is read only. A maintainer reviews the generated plan, runs the affected profile and tuple verification, and merges any accepted update through the normal signed pull request process.
